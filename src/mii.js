...
export var editMii = {
    ...
    mingleOff: true,
    unEdit2: [
      0x42, 0x40, 0x31, 0xbd, 0x28, 0xa2, 0x08, 0x8c, 0x08, 0x40, 0x14, 0x49,
      0xb8, 0x8d, 0x00, 0x8a, 0x00, 0x8a, 0x25, 0x04, 0x00,
    ],
    creatorName: '',
    studio: new Uint8Array([
      0x08, 0x00, 0x40, 0x03, 0x08, 0x04, 0x04, 0x02, 0x02, 0x0c, 0x03, 0x01,
      0x06, 0x04, 0x06, 0x02, 0x0a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08,
      0x04, 0x00, 0x0a, 0x01, 0x00, 0x21, 0x40, 0x04, 0x00, 0x02, 0x14, 0x03,
      0x13, 0x04, 0x17, 0x0d, 0x04, 0x00, 0x0a, 0x04, 0x01, 0x09,
    ]),
    previewData:
      '000f165d6574777a7f848f9399a6a9b6bbb8bfc6cdd4dbe2f1fc0310181f450c0f161b161c1619151f22292a353b39',
  };
...
export function encodeStudio(studio) {
  let n = 0;
  let eo;
...
export function miiFileRead(buf){
	console.log(buf);
